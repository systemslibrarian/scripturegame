...
const BASE_VERSES: Verse[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    answers: ["LORD", "FOREVER", "PREACHED"],
    decoys: ["GOD", "ALWAYS", "SPOKEN", "GIVEN"],
    themeId: "gods-word",
    themeLabel: "God's Word",
    devotional:
      "Everything else fades — grass withers, flowers fall — but the word of the Lord endures forever. And this is not some distant, abstract truth. It is the very word preached to you. The gospel you received is eternal, unshakable, and alive.",
    applicationPrompt: "How does knowing God's word endures forever change how seriously you take it today?",
    difficulty: "beginner",
  },
  {
    id: "jn101115",
    ...
    parts: [
      ...
      " for the sheep. The hired hand is not the shepherd and does not own the sheep. So when he sees the ",
      " coming, he abandons the sheep and runs away. Then the wolf attacks the flock and ",
      " it. The man runs away because he is a hired hand and cares nothing for the sheep. I am the good shepherd; I know my ",
      " and my sheep know me — just as the Father knows me and I know the ",
      ", and I lay down my life for the sheep.",
    ],
    answers: ["SHEPHERD", "LIFE", "WOLF", "SCATTERS", "SHEEP", "FATHER"],
    decoys: ["KEEPER", "SOUL", "ENEMY", "DESTROYS", "FLOCK", "LORD"],
    themeId: "love",
    themeLabel: "God's Love",
    devotional:
      "A hired hand works for pay. A shepherd works for love. Jesus is not protecting you because it is His job — He is laying down His life because you are His. He knows you by name, and He will not run when the wolf comes.",
    applicationPrompt: "Do you live as though you belong to the Good Shepherd, or as though you are on your own when danger comes?",
    difficulty: "expert",
  },
  {
    id: "jn102728",
    ...
    answers: ["VOICE", "FOLLOW", "LIFE", "HAND"],
    decoys: ["WORD", "OBEY", "GRACE", "ARMS", "CARE"],
    themeId: "salvation",
    themeLabel: "Salvation",
    devotional:
      "Three promises in two verses: He knows you. He gives you eternal life. No one can snatch you away. Your security is not in the strength of your grip on Him, but in the strength of His grip on you.",
    applicationPrompt: "Are you listening for the Shepherd's voice today, or are you following other voices?",
    difficulty: "beginner",
  },
  {
    id: "lk1547",
    ...
    parts: [
      ...
      " and goes home. Then he calls his friends and neighbors together and says, 'Rejoice with me; I have found my lost ",
    ...
    answers: ["NINETY-NINE", "LOST", "SHOULDERS", "SHEEP", "HEAVEN"],
    decoys: ["FLOCK", "MISSING", "BACK", "LAMB", "GLORY"],
    themeId: "grace",
    themeLabel: "Grace",
    devotional:
      "The shepherd does not wait for the lost sheep to find its way back. He goes after it. He searches until he finds it. And when he does, he does not scold — he rejoices. That is the heart of God toward you when you wander.",
    applicationPrompt: "Have you wandered from the Shepherd? He is not angry — He is searching for you. Will you let Him find you?",
    difficulty: "expert",
  },
  {
    id: "is4011",
    ...
    parts: [
      "He tends his ",
      " like a shepherd: He gathers the ",
      " in his arms and carries them close to his ",
      "; he gently leads those that have ",
      ".",
    ],
    answers: ["FLOCK", "LAMBS", "HEART", "YOUNG"],
    decoys: ["SHEEP", "CHILDREN", "SIDE", "LITTLE", "SMALL"],
    themeId: "provision",
    themeLabel: "Provision",
    devotional:
      "This is not a distant, demanding God. He gathers. He carries. He holds close to His heart. And He gently leads — not drives, not pushes. The tenderness of God is on full display here: strong enough to carry you, gentle enough to lead you.",
    applicationPrompt: "Where do you need to be carried close to God's heart right now instead of trying to walk on your own strength?",
    difficulty: "beginner",
  },
  {
    id: "ezek3412",
    ...
    answers: ["FLOCK", "SHEEP", "PLACES", "DARKNESS"],
    decoys: ["LAMBS", "PEOPLE", "LANDS", "GLOOM", "STORMS"],
    themeId: "provision",
    themeLabel: "Provision",
    devotional:
      "God does not lose track of His scattered sheep. Even on a day of clouds and darkness — when you cannot see Him — He sees you. He will rescue. He will gather. The scattering is not the end of the story.",
    applicationPrompt: "Do you feel scattered or lost right now? How does it change things to know that God is actively seeking you out?",
    difficulty: "intermediate",
  },
  {
    id: "1pet54",
    ...
    answers: ["SHEPHERD", "GLORY", "FADE AWAY"],
    decoys: ["PASTOR", "LIFE", "PERISH", "HONOR", "END"],
    themeId: "hope",
    themeLabel: "Hope",
    devotional:
      "There is a day coming when the Chief Shepherd will appear. Not a hired hand, not an under-shepherd, but the One who owns the flock. And on that day, faithfulness will be rewarded with a crown that never fades. Every sacrifice made in His name will be worth it.",
    applicationPrompt: "How does the promise of an unfading crown change how you serve others today — even when no one notices?",
    difficulty: "beginner",
  },
  {
    id: "heb1320",
    ...
    parts: [
      "Now may the God of ",
      ", who through the blood of the eternal ",
      " brought back from the dead our Lord ",
      ", that great Shepherd of the ",
      ",",
    ],
    answers: ["PEACE", "COVENANT", "JESUS", "SHEEP"],
    decoys: ["GRACE", "PROMISE", "CHRIST", "FLOCK", "LAMB"],
    themeId: "peace",
    themeLabel: "Peace",
    devotional:
      "Jesus is called the great Shepherd — not merely good, but great. And He was brought back from the dead through the blood of an eternal covenant. The resurrection proves that the Shepherd's sacrifice was accepted, and His care for you is permanent.",
    applicationPrompt: "How does knowing Jesus conquered death as your Shepherd give you peace in whatever you are facing today?",
    difficulty: "intermediate",
  },
];
